      ...
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <Reveal delay={0.4}>
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            <Link to="/contact" search={{ selected_package: "ai-receptionist" }} className={`${primaryCta} inline-flex px-6 py-3 text-sm`}>
  ...
  return (
    <section className="relative isolate overflow-hidden border-t border-white/10 bg-[#0a0b0b] px-6 py-28 text-white lg:py-36">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <Reveal delay={0.3}>
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            <Link to="/contact" search={{ selected_package: "ai-receptionist" }} className={`${primaryCta} inline-flex px-7 py-3.5 text-sm`}>
